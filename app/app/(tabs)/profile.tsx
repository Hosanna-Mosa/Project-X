...
const styles = StyleSheet.create({
  ...
  summaryMeta: { flex: 1, gap: 2, marginRight: 12 },
  summaryName: { fontSize: 20, fontWeight: '700', color: '#fff' },
  ...
  infoIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: '#F8FAFC', alignItems: 'center', justifyContent: 'center' },
  infoText: { flex: 1, gap: 2 },
  infoLabel: { fontSize: 11, fontWeight: '700', color: '#94A3B8', textTransform: 'uppercase' },
  infoValue: { fontSize: 15, fontWeight: '600', color: '#1E293B', flexShrink: 1 },
  ...
  menuBtnIcon: { width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  menuBtnLabel: { flex: 1, fontSize: 16, fontWeight: '600', color: '#1E293B' },
