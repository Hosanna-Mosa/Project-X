...
const styles = StyleSheet.create({
  ...
  modalSearchInput: { flex: 1, marginLeft: 12, fontSize: 15, color: "#111827" },
  modalSectionTitle: { fontSize: 13, fontWeight: "600", color: "#4B5563", marginBottom: 12 },
  topCitiesGrid: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginBottom: 24 },
  topCityCard: {
    width: "31%", backgroundColor: "#FFFFFF", borderRadius: 12, alignItems: "center", 
    paddingVertical: 16, marginBottom: 12, borderWidth: 1, borderColor: "#E5E7EB"
  },
  topCityName: { fontSize: 13, fontWeight: "600", color: "#111827", marginTop: 8 },
  otherCityRow: {
    backgroundColor: "#FFFFFF", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 16,
    marginBottom: 8, borderWidth: 1, borderColor: "#E5E7EB"
  },
  otherCityText: { fontSize: 15, fontWeight: "500", color: "#111827" },
});
