...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 14, fontWeight: "800", color: Colors.light.text },
  ...
  addressLabel: { fontSize: 13, fontWeight: "700", color: Colors.light.text },
  addressLine: { fontSize: 11, color: Colors.light.textSecondary },
  addressPhone: { fontSize: 10, color: Colors.light.textMuted },
  emptyState: {
    alignItems: "center",
    justifyContent: "center",
    paddingVertical: 60,
